  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://medequip-api.vercel.app/api/auth/resend-verification",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <div className="flex justify-center py-20">
        <div
          className="lg:w-[668px] md:w-[568px] sm:w-[468px] w-[368px] py-8 px-8 
        ...
        >
          ...
          <p className="text-center lg:text-[18px] md:text-[18px] sm:text-[16px] text-[14px] pt-4 pb-10">
            Click on the link sent to the email account you registered to verify
            your account
          </p>
